  ...
  return (
    <section id="contact" ref={rootRef} className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <p
          className="contact-reveal mx-auto mt-4 max-w-md text-base leading-relaxed"
        ...
        <div className="contact-reveal glass-strong glow-ring mx-auto mt-10 flex max-w-md flex-col items-center gap-5 rounded-3xl p-8">
          <a
